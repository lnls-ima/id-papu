...
COMMENTS = [
        ...
        ('data in https://github.com/lnls-ima/id-papu/tree/master/'
         'feedforward-correctors/model-01/measurement/magnetic/rotcoil'),
        ('script https://github.com/lnls-ima/id-papu/tree/master/'
...
RotCoilMeas_SIFCH.magnet_type_name = 'id-papu/feedforward-correctors/'
RotCoilMeas_SIFCH.model_version = 'model-01/'
...
def create_excdata(serials, exc_type, currs, harms, fit_order):
    ...
    excdata_label = {
        'ch': 'si-corrector-papu50-ch',
        'cv': 'si-corrector-papu50-cv',
        'qs':'si-corrector-papu50-qs'}[exc_type]
